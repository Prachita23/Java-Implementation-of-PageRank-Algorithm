...
JAR_NAME="$HOME/PrProj2/target/SparkProject-1.0.jar"
...
$JAVA_HOME/bin/java -cp $CLASSPATH $CONFIG_OPTS prachita.PageRank $1 $2 $3

hadoop fs -cat result/part-* > result.txt
